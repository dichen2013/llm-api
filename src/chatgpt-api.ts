...
export class ChatGPTAPI {
  ...
  constructor(opts: types.ChatGPTAPIOptions) {
    ...
    if (this._systemMessage === undefined) {
      ...
      this._systemMessage = `You are Xbrain Chat Bot, a large language model trained by Intellicloud. Respond using markdown.`
    } else {
      this._systemMessage =
        `You are Xbrain Chat Bot, a large language model trained by Intellicloud. ` +
        this._systemMessage
    }
    ...
    if (!this._apiKey) {
      throw new Error('xbrain missing required apiKey')
    }
  ...
  async sendMessage(
            ...
            url,
            {
              ...
              onMessage: (data: string) => {
                ...
                try {
                  ...
                  console.warn('xbrain stream SEE event unexpected error', err)
                  return reject(err)
                }
              }
            },
    ...
    if (timeoutMs) {
      ...
      return pTimeout(responseP, {
        ...
        message: 'xbrain timed out waiting for response'
      })
    } else {
      return responseP
    }
